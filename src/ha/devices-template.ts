export const devices = (model: string) => ({
  ...
  sensor: [
    ...
    },
    {
      ...
      state_class: `total_increasing`,
      value_template: `{{ (value_json.modem_status.modems[0].network.tx + value_json.modem_status.modems[0].network.rx) or (value_json.modem_status.modems[0].network.traffic_total) }}`,
      device_class: `data_size`,
      unit_of_measurement: `B`,
      icon: `mdi:counter`,
      entity_category: `diagnostic`,
    },
    {
      ...
      state_class: `total_increasing`,
      value_template: `{{ (((value_json.modem_status.modems[0].network.tx + value_json.modem_status.modems[0].network.rx) or (value_json.modem_status.modems[0].network.traffic_total)) / 1073741824) | round(3) }}`,
      device_class: `data_size`,
